            ...
            <div class="card py-3 px-4" style="background-color: #f7f7f79c">
                <div class="row">
                    ...
                    <div class="text-center">
                        <form action="{{ route('account.avatar.update') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="avatar-container">
                                <label for="avatar">
                                    <img id="imagePreview" src="{{ asset($user->avatar_url) }}" class="rounded-circle img-thumbnail" alt="Profile Picture" style="width: 100px; height: 100px; object-fit: cover;">
                                </label>
                                <input type="file" id="avatar" name="avatar" accept="image/*" hidden onchange="previewImage(event)">
                    ...
                    <ul class="nav flex-column mt-3">
                        ...
                        <li class="nav-item border-bottom">
                            <a class="nav-link text-dark" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link text-danger " onclick="event.preventDefault(); document.getElementById('delete-form').submit();">
                                <i class="fa-solid fa-trash"></i> Delete your account
                            </a>
                            <form id="delete-form" action="{{ route('account.delete', Auth::user()->username) }}" method="POST" style="display: none;">
                                @csrf
                                @method('DELETE')
                            </form>
                        </li>
                                ...
                                <div class="media-body pt-3">
                                    ...
                                    <div class="form-group pt-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="gender" id="male" value="male" :checked="{{ ($user->gender ?? '') === 'male' }}"> <label class="form-check-label" for="male">Male</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="gender" id="female" value="female" :checked="{{ ($user->gender ?? '') === 'female' }}"> <label class="form-check-label" for="female">Female</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group pt-3">
                    ...
                    <div class="row">
                        ...
                        <div class="card mb-3 mt-3 no-border">
                            <div class="row no-gutters align-items-center ">
                                <div class="col-md-3">
                                    <img src="{{ asset('images/shoe1-black.jpg') }}" alt="Strutter shoe" style="width:100%">
                                </div>
                                ...
                                <div class="col-md-2">
                                    <i class="btn btn-light rounded rounded-5" style="font-weight: bold; color: rgb(1, 125, 1); ">Completed</i>
                                </div>
                            </div>
                        </div>
                    </div>
