    ...
    <div class="row">
        <div class="col-md-3 offset-md-1">
            <div class="card py-3 px-4" style="background-color: #f7f7f79c">
                <div class="row ">
                    <div class="col-md-4">
                        <img src="{{ asset('images/avatar.jpg') }}" class="rounded-circle" style="width:100%" alt="Profile Picture">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                        ...
                        <div class="media mb-3">
                            ...
                            <div class="media-body pt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control rounded rounded-4" id="name" value="Elite Markson" readonly>
                                </div>
                                <div class="form-group pt-3">
                                    <label for="dob" class="pb-2">Date Of Birth</label>
                                    <input type="text" class="form-control rounded rounded-4" id="dob" value="20/01/1990" readonly>
                                </div>
                                <div class="form-group pt-3">
                                    <label class="pb-2">Gender</label><br>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="gender" id="male" value="male" disabled checked>
                                ...
                                <div class="form-group pt-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control rounded rounded-4" id="phone" value="0136735326" readonly>
                                    </div>
                                </div>
                                <div class="form-group pt-3">
                                    <label class="pb-2" for="email">Email</label>
                                    <input type="email" class="form-control rounded rounded-4" id="email" value="example@gmail.com" readonly>
                                </div>
